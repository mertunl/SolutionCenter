        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostOfNumber = table.Column<int>(type: "int", nullable: true),
                    SentOfOfferNumber = table.Column<int>(type: "int", nullable: true),
                    ReceivedOfOfferNumber = table.Column<int>(type: "int", nullable: true),
                    AppUserID = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stats_AspNetUsers_AppUserID",
                        column: x => x.AppUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    PostID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Offeree = table.Column<string>(type: "nvarchar(max)", nullable: true),
